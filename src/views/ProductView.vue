<template>
  ...
  >
    ...
    <div class="row">
      <div class="col-md-6">
        <img class="w-100 h-100" :src="product.image" alt="productImg" />
      </div>
      <div class="col-md-6">
        <div class="card h-100">
          <div
            class="h-100 d-flex justify-content-evenly gap-5 align-items-start flex-column p-5"
          >
