    ...
    <div class="w-100 row justify-content-center">
      <div id="registerzone" v-if="!user" class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div id="cardzone" class="card shadow text-white">
          <div class="card-title text-center text-white"></div>
      ...
      <div v-if="clicked && !user">
        ...
        <div v-else>
          <div v-if="registerComplete">Signing In...</div>
...
.btn-grad {
  ...
  color: white;
  box-shadow: 0 0 20px rgb(31, 29, 29);
  border-radius: 10px;
  font-size: 12px;
}

.border-bottom {
  border-bottom: 2px solid rgb(85, 7, 7) !important;
}
